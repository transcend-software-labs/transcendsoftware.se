...
func (p *Postgres) UpdateProject(ctx context.Context, pr *project.Project) error {
	tag, err := p.pool.Exec(ctx,
		`UPDATE projects SET
		   ...
		   domain_intent=$44, domain_intent_buy=$45, domain_cost_ore=$46, preview_host=$47, domain_paid_through=$48, planner_profile=$49, impl_profile=$50, domain_prepaid=$51, review_profile=$52, code_review=$53, code_review_at=$54
		 WHERE id=$1`,
